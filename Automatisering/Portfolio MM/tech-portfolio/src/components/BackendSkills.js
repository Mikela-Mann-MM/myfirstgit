// src/components/BackendSkills.js
  ...
  app.listen(port, () => {
    ...
    "projects": [
      ...
      },
      {
        ...
        "demo_url": "https://tasks.yourdomain.com"
      }
    ]
  }</code></pre>
            </div>
      ...
      <div class="backend-skills-info">
        ...
        <ul class="skills-list">
          ...
          <li><span class="skill-highlight">Database Management</span> - Using SQLite for efficient data storage and retrieval with proper schema design</li>
          <li><span class="skill-highlight">Authentication Systems</span> - Implementing secure user authentication and authorization</li>
          <li><span class="skill-highlight">Full-Stack Integration</span> - Seamlessly connecting frontend interfaces with backend services</li>
        </ul>
        
        <p>This combination of frontend expertise and backend capabilities allows me to deliver complete, production-ready applications independently.</p>
      </div>
    `
  
    // Add some interactivity to the API demo
    ...
    endpoints.forEach(endpoint => {
      endpoint.addEventListener('click', () => {
        ...
        // In a real implementation, this would show different responses based on endpoint
